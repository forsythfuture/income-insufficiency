...
All Consumer Expenditure Survey (CES) data was gathered from the BLS's CES website. The following expenses were collected from CES data: health insurance (by household size and age), transportation, appareal and services, housekeeping supplies personal care products and services, reading, and misc.
...
seventeen <- inf_adj_child_care(child, 2017, 2018)
...
child <- child %>%
  bind_rows(., list(seventeen, eight_ten, eleven_fourteen)) %>%
...
# write_csv(child, 'cleaned_data/child_care.csv')
```