...
# Run this script 1st 
#
# This script calculates income insufficiency for each person in 2018. It calculates ~
# expenses for each individual and creates a column that is a boolean representing ~
# whether the person is income insufficient; with TRUE being yes and FALSE being no.
# A person is income insufficient if they live in an economic unit where unit average ~
# expenses are greater than unit income.
####################################################################################
