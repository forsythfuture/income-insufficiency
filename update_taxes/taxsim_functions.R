...
pop_taxes <- function(file_path, year, household = TRUE) {
  
  # file_path: path to PUMS file
  # year: year of PUMS dataset
  # household: boolean, whether to calculate household or individual taxes
